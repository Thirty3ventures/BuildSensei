...
This document explains how BuildSensei is written so future Claude instances can contribute consistently.

## Core Philosophy

BuildSensei is a **meta-prompting system** where every file is both implementation and specification. Files teach Claude how to build software systematically. The system optimizes for:
...
### Slash Commands (`commands/sensei/*.md`)

```yaml
---
name: sensei:command-name
...
### Workflows (`buildsensei/workflows/*.md`)
...
### Templates (`buildsensei/templates/*.md`)
...
### References (`buildsensei/references/*.md`)
...
| Commands | `sensei:kebab-case` | `sensei:execute-phase` |
