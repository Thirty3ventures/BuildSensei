...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /sensei:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/buildsensei/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Quality check:** Before finalizing findings, consult ~/.claude/buildsensei/references/research-pitfalls.md to avoid common research gaps.

7. **Create DISCOVERY.md** using ~/.claude/buildsensei/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/buildsensei/templates/discovery.md:
...
6. **Quality check:** Before finalizing findings, consult ~/.claude/buildsensei/references/research-pitfalls.md to ensure comprehensive coverage and avoid common research gaps.

7. **Create comprehensive DISCOVERY.md:**

   - Full structure from ~/.claude/buildsensei/templates/discovery.md
...
Use ~/.claude/buildsensei/templates/discovery.md.
...
1. Discuss phase context (/sensei:discuss-phase [current-phase])
2. Create phase plan (/sensei:plan-phase [current-phase])
