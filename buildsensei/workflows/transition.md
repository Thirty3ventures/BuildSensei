...
Exit skill and invoke SlashCommand("/sensei:plan-phase [X+1]")
...
**Also available:**
- `/sensei:discuss-phase [X+1]` — gather context first
- `/sensei:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/sensei:complete-milestone {version}")
