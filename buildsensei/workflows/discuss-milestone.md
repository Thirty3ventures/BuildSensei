...
Did you want to:
1. Complete current milestone first (/sensei:complete-milestone)
2. Add phases to current milestone (/sensei:add-phase)
...
- options (ALL THREE REQUIRED):
  - "Create milestone" - Proceed to /sensei:new-milestone
...
Use template from ~/.claude/buildsensei/templates/milestone-context.md
...
- Context handed off to /sensei:new-milestone
</success_criteria>
