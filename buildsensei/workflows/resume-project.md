...
**If .planning/ doesn't exist:** This is a new project - route to /sensei:new-project
</step>
...
⚠️  Interrupted agent detected:
    ...
    Resume with: /sensei:resume-task

[If pending todos exist:]
📋 [N] pending todos — /sensei:check-todos to review
...
→ Primary: Resume interrupted agent (/sensei:resume-task)
...
1. Resume interrupted agent (/sensei:resume-task) [if interrupted agent found]
   OR
1. Resume from checkpoint (/sensei:execute-plan .planning/phases/XX-name/.continue-here-02-01.md)
   OR
1. Execute next plan (/sensei:execute-plan .planning/phases/XX-name/02-02-PLAN.md)
   OR
1. Discuss Phase 3 context (/sensei:discuss-phase 3) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/sensei:plan-phase 3) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/sensei:discuss-phase [N]` — gather context first
  - `/sensei:research-phase [N]` — investigate unknowns
