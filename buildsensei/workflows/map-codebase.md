...
1. **Read template file** from `~/.claude/buildsensei/templates/codebase/{name}.md`
...
**Also available:**
- Re-run mapping: `/sensei:map-codebase`
...
- User offered clear next steps in BuildSensei style
</success_criteria>
