...
1. ~/.claude/buildsensei/templates/research-project/SUMMARY.md
2. ~/.claude/buildsensei/templates/research-project/STACK.md
3. ~/.claude/buildsensei/templates/research-project/FEATURES.md
4. ~/.claude/buildsensei/templates/research-project/ARCHITECTURE.md
5. ~/.claude/buildsensei/templates/research-project/PITFALLS.md
...
- Read ~/.claude/buildsensei/templates/research-project/STACK.md for format
...
Use this template structure:
- Read ~/.claude/buildsensei/templates/research-project/FEATURES.md for format
...
Use this template structure:
- Read ~/.claude/buildsensei/templates/research-project/ARCHITECTURE.md for format
...
Use this template structure:
- Read ~/.claude/buildsensei/templates/research-project/PITFALLS.md for format
