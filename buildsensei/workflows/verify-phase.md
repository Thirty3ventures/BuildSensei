...
- ~/.claude/buildsensei/references/goal-backward.md (derivation process)
- ~/.claude/buildsensei/references/verification-patterns.md (detection patterns)
- ~/.claude/buildsensei/templates/verification-report.md (output format)
</required_reading>
...
See ~/.claude/buildsensei/references/goal-backward.md for detailed derivation guidance.
</step>
...
See ~/.claude/buildsensei/templates/verification-report.md for complete template.
</step>
