...
1. ~/.claude/buildsensei/templates/roadmap.md
2. ~/.claude/buildsensei/templates/state.md
3. ~/.claude/buildsensei/templates/requirements.md
...
- NOT for scope creep or "nice to haves" (capture with /sensei:add-todo instead)
...
Use template from `~/.claude/buildsensei/templates/roadmap.md`.

Initial roadmaps use integer phases (1, 2, 3...).
Decimal phases added later via /sensei:insert-phase command (if it exists).
...
Use template from `~/.claude/buildsensei/templates/state.md`.
