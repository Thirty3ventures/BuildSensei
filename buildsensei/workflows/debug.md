...
<references>
@~/.claude/buildsensei/references/debugging/debugging-mindset.md
@~/.claude/buildsensei/references/debugging/hypothesis-testing.md
@~/.claude/buildsensei/references/debugging/investigation-techniques.md
@~/.claude/buildsensei/references/debugging/verification-patterns.md
@~/.claude/buildsensei/references/debugging/when-to-research.md
</references>

<template>
@~/.claude/buildsensei/templates/DEBUG.md
</template>
...
"Context filling up. Safe to /clear - run /sensei:debug to resume."
</step>
...
**Do NOT proceed to fix_and_verify.** The fix will be planned by /sensei:plan-fix using this diagnosis.
</step>
...
- question: "What now?"
- options:
  - "Continue working" - Back to /sensei:progress
