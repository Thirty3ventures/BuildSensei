...
**Purpose:** Persist milestone discussion context so `/clear` can be used between commands. This file is consumed by `/sensei:new-milestone` and deleted after the milestone is created.
...
**Generated:** [date]
**Status:** Ready for /sensei:new-milestone
...
*This file is temporary. It will be deleted after /sensei:new-milestone creates the milestone.*
```
...
**Lifecycle:**
1. `/sensei:discuss-milestone` creates this file at end of discussion
2. User runs `/clear` (safe now - context is persisted)
3. `/sensei:new-milestone` reads this file
4. `/sensei:new-milestone` uses context to populate milestone
5. `/sensei:new-milestone` deletes this file after successful creation
