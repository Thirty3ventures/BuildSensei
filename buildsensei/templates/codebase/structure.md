...
│   └── BuildSensei/           # BuildSensei-specific commands
├── buildsensei/     # Skill resources
...
**commands/BuildSensei/**
- Purpose: Slash command definitions for Claude Code
- Contains: *.md files (one per command)
- Key files: new-project.md, plan-phase.md, execute-plan.md
- Subdirectories: None (flat structure)

**buildsensei/references/**
...
**New Slash Command:**
- Primary code: `commands/BuildSensei/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `buildsensei/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `buildsensei/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/buildsensei/workflows/{name}.md`

**New Reference Document:**
- Implementation: `buildsensei/references/{name}.md`
