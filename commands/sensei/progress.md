...
Run /sensei:new-project to start a new project.
```

Exit.

If missing STATE.md or ROADMAP.md: inform what's missing, suggest running `/sensei:new-project`.
</step>
...
## Pending Todos
- [count] pending — /sensei:check-todos to review

## Active Debug Sessions
- [count] active — /sensei:debug to continue
...
`/sensei:execute-plan [full-path-to-PLAN.md]`
...
`/sensei:plan-phase {phase-number}`
...
**Also available:**
- `/sensei:discuss-phase {phase}` — gather context first
- `/sensei:research-phase {phase}` — investigate unknowns
- `/sensei:list-phase-assumptions {phase}` — see Claude's assumptions
...
**Also available:**
- `/sensei:execute-plan [path]` — continue with other work first
- `/sensei:verify-work {phase}` — run more UAT testing
...
**Also available:**
- `/sensei:verify-work {Z}` — user acceptance test before continuing
...
**Also available:**
- `/sensei:verify-work` — user acceptance test before completing milestone
...
- Phase complete but next phase not planned → offer `/sensei:plan-phase [next]`
