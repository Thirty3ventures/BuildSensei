---
name: sensei:plan-milestone-gaps
...
<objective>
Create all phases necessary to close gaps identified by `/sensei:audit-milestone`.

Reads MILESTONE-AUDIT.md, groups gaps into logical phases, creates phase entries in ROADMAP.md, and offers to plan each phase.

One command creates all fix phases — no manual `/sensei:add-phase` per gap.
</objective>

<execution_context>
@~/.claude/buildsensei/references/principles.md
@~/.claude/buildsensei/workflows/plan-phase.md
</execution_context>
...
```
No audit gaps found. Run `/sensei:audit-milestone` first.
```
...
**Also available:**
- `/sensei:execute-phase {N}` — if plans already exist
...
`/sensei:audit-milestone` — re-audit to verify gaps closed
`/sensei:complete-milestone {version}` — archive when audit passes
```
...
- [ ] Changes committed
- [ ] User knows to run `/sensei:plan-phase` next
</success_criteria>
