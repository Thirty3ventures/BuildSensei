...
Output: Context gathered, then routes to /sensei:new-milestone
</objective>

<execution_context>
@~/.claude/buildsensei/references/principles.md
@~/.claude/buildsensei/workflows/discuss-milestone.md
</execution_context>
...
4. Hand off to /sensei:new-milestone with gathered context
