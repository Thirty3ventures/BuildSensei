...
- Example: `/sensei:add-phase Add authentication` → description = "Add authentication"
- Example: `/sensei:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /sensei:add-phase <description>
Example: /sensei:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /sensei:plan-phase {N} to break down)
...
**Also available:**
- `/sensei:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /sensei:insert-phase)
- Don't create plans yet (that's /sensei:plan-phase)
