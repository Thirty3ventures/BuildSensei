...
Run after `/sensei:new-project`, before `/sensei:define-requirements`.
...
@~/.claude/buildsensei/workflows/research-project.md
@~/.claude/buildsensei/templates/research-project/SUMMARY.md
@~/.claude/buildsensei/templates/research-project/STACK.md
@~/.claude/buildsensei/templates/research-project/FEATURES.md
@~/.claude/buildsensei/templates/research-project/ARCHITECTURE.md
@~/.claude/buildsensei/templates/research-project/PITFALLS.md
</execution_context>
