...
<execution_context>
@~/.claude/buildsensei/references/plan-format.md
...
UAT.md files are created by /sensei:verify-work during testing.
Run /sensei:verify-work {phase} first.
```
Exit.
...
Run /sensei:verify-work to complete testing first.
```
Exit.
</step>
...
Read the "Issues for /sensei:plan-fix" section.
...
- Tests pass
- Ready for re-verification with /sensei:verify-work {phase}
</success_criteria>
...
**If "Execute fix plan":**
Invoke `/sensei:execute-plan .planning/phases/XX-name/{phase}-FIX.md`
...
`/sensei:execute-plan .planning/phases/XX-name/{phase}-FIX.md`
```
</step>
