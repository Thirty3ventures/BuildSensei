...
@~/.claude/buildsensei/templates/phase-prompt.md
@~/.claude/buildsensei/references/plan-format.md
@~/.claude/buildsensei/references/scope-estimation.md
...
**Load phase context if exists (created by /sensei:discuss-phase):**
...
<process>
1. Check .planning/ directory exists (error if not - user should run /sensei:new-project)
