...
@~/.claude/buildsensei/workflows/research-phase.md
@~/.claude/buildsensei/templates/research.md
@~/.claude/buildsensei/references/research-pitfalls.md
</execution_context>
