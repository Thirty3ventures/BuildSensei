...
<execution_context>
@~/.claude/buildsensei/workflows/map-codebase.md
@~/.claude/buildsensei/templates/codebase/stack.md
@~/.claude/buildsensei/templates/codebase/architecture.md
@~/.claude/buildsensei/templates/codebase/structure.md
@~/.claude/buildsensei/templates/codebase/conventions.md
@~/.claude/buildsensei/templates/codebase/testing.md
@~/.claude/buildsensei/templates/codebase/integrations.md
@~/.claude/buildsensei/templates/codebase/concerns.md
</execution_context>
...
- Before /sensei:new-project (brownfield codebases) - creates codebase map first
- After /sensei:new-project (greenfield codebases) - updates codebase map as code evolves
...
6. Offer next steps (typically: /sensei:new-project or /sensei:plan-phase)
</process>
