---
type: prompt
name: sensei:complete-milestone
...
- @~/.claude/buildsensei/workflows/complete-milestone.md (main workflow)
- @~/.claude/buildsensei/templates/milestone-archive.md (archive template)
  </execution_context>
...
0. **Check for audit:**
   ...
   - If missing or stale: recommend `/sensei:audit-milestone` first
   - If audit status is `gaps_found`: recommend `/sensei:plan-milestone-gaps` first
   ...
   ⚠ No milestone audit found. Run `/sensei:audit-milestone` first to verify
   requirements coverage, cross-phase integration, and E2E flows.

   {If audit has gaps:}
   ⚠ Milestone audit found gaps. Run `/sensei:plan-milestone-gaps` to create
