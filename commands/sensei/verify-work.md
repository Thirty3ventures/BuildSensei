...
Output: {phase}-UAT.md tracking all test results, issues logged for /sensei:plan-fix
</objective>

<execution_context>
@~/.claude/buildsensei/workflows/verify-work.md
...
- Don't fix issues during testing — log for /sensei:plan-fix
</anti_patterns>
