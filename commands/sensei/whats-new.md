---
name: sensei:whats-new
description: See what's new in BuildSensei since your installed version
---
...
```bash
cat ~/.claude/buildsensei/VERSION 2>/dev/null
```

**If VERSION file missing:**
```
## BuildSensei What's New

**Installed version:** Unknown

Your installation doesn't include version tracking.

**To fix:** `npx buildsensei-cc --global`
...
- URL: `https://raw.githubusercontent.com/glittercowboy/buildsensei/main/CHANGELOG.md`
...
```bash
cat ~/.claude/buildsensei/CHANGELOG.md 2>/dev/null
```
...
[View full changelog](https://github.com/glittercowboy/buildsensei/blob/main/CHANGELOG.md)
```
...
**To update:** `npx buildsensei-cc --global`
```
