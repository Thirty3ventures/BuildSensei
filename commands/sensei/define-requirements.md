---
name: sensei:define-requirements
...
Run before `/sensei:create-roadmap`.
...
@~/.claude/buildsensei/workflows/define-requirements.md
@~/.claude/buildsensei/templates/requirements.md
</execution_context>
