...
- Example: `/sensei:remove-phase 17` → phase = 17
- Example: `/sensei:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /sensei:remove-phase <phase-number>
Example: /sensei:remove-phase 17
```
...
To abandon current work, use /sensei:pause-work instead.
```
...
Would you like to:
- `/sensei:progress` — see updated roadmap status
