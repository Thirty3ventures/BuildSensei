...
Verify cross-phase wiring and E2E user flows.",
  subagent_type="sensei-integration-checker"
)
```
...
- `/sensei:complete-milestone {version}` — proceed anyway (accept tech debt)
```
